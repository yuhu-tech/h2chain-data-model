...
type CooperationConnection {
  pageInfo: PageInfo!
  edges: [CooperationEdge]!
  aggregate: AggregateCooperation!
}

input CooperationCreateInput {
  adviserid: String!
  hotelid: String!
}
...
type CooperationPreviousValues {
  id: ID!
  adviserid: String!
  hotelid: String!
}

type CooperationSubscriptionPayload {
  mutation: MutationType!
  node: Cooperation
  updatedFields: [String!]
...
input CooperationSubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: CooperationWhereInput
  AND: [CooperationSubscriptionWhereInput!]
  OR: [CooperationSubscriptionWhereInput!]
  NOT: [CooperationSubscriptionWhereInput!]
}

input CooperationUpdateInput {
  adviserid: String
  hotelid: String
}

input CooperationUpdateManyMutationInput {
  adviserid: String
  hotelid: String
}

input CooperationWhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  AND: [CooperationWhereInput!]
  OR: [CooperationWhereInput!]
  NOT: [CooperationWhereInput!]
}

input CooperationWhereUniqueInput {
  id: ID
}
...
type Mutation {
  ...
  createCooperation(data: CooperationCreateInput!): Cooperation!
  updateCooperation(data: CooperationUpdateInput!, where: CooperationWhereUniqueInput!): Cooperation
  updateManyCooperations(data: CooperationUpdateManyMutationInput!, where: CooperationWhereInput): BatchPayload!
  upsertCooperation(where: CooperationWhereUniqueInput!, create: CooperationCreateInput!, update: CooperationUpdateInput!): Cooperation!
  deleteCooperation(where: CooperationWhereUniqueInput!): Cooperation
  deleteManyCooperations(where: CooperationWhereInput): BatchPayload!
...
type Query {
  ...
  cooperation(where: CooperationWhereUniqueInput!): Cooperation
  cooperations(where: CooperationWhereInput, orderBy: CooperationOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Cooperation]!
  cooperationsConnection(where: CooperationWhereInput, orderBy: CooperationOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): CooperationConnection!
...
type Subscription {
  ...
  cooperation(where: CooperationSubscriptionWhereInput): CooperationSubscriptionPayload
